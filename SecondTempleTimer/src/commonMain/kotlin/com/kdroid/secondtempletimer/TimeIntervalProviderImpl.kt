...
class TimeIntervalProviderImpl : TimeIntervalProvider {
    override fun getCurrentJewishDate(): JewishDate = JewishDate()

    override fun getSecondTempleDestructionDate(): JewishDate = JewishDate(3830, HebrewMonth.AV, 9)
    ...
    override fun getTodayJerusalemSunset(): Long = getJerusalemSunset(true)

    override fun getYesterdayJerusalemSunset(): Long = getJerusalemSunset(false)
